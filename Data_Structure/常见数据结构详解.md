...
<img src="D:\CodeLearning\ComputerScience\MyNotes-本机\Data_Structure\imgs\1642733710377.png" alt="1642733710377" style="zoom:50%;" />
...
<img src="D:\CodeLearning\ComputerScience\MyNotes-本机\Data_Structure\imgs\1642733855845.png" alt="1642733855845" style="zoom:50%;" />
...
链表（Linked list）是一种常见的基础数据结构，是一种线性表，但是并不会按线性的顺序存储数据，除了数据域，还增加了指针域用于构建链式的存储数据，**链表中每一个节点都包含此节点的数据和指向下一节点地址的指针（Pointer）**。由于不必须按顺序存储，链表在**插入和删除的时候可以达到 $O(1)$ 的复杂度，只需简单修改指针指向**，但是**查找一个节点或者访问特定编号的节点则需要 $O(n)$ 的时间。**
 ...
 <img src="D:\CodeLearning\ComputerScience\MyNotes-本机\Data_Structure\imgs\26173213981.png" alt="图片" style="zoom: 67%;" /> 
...
> - isEmpty：返回一个布尔值，表示当前stack是否为空栈。
 ...
 <img src="https://mmbiz.qpic.cn/mmbiz_gif/TdGLaSU675gwBawZm4AtKbyUUqEHRqCKGnHQrX7Z1xF4BncrEv8nUf8icSMK69bmp2mCDcDLY6kZ6fLwjq4IcTg/640?wx_fmt=gif&amp;tp=webp&amp;wxfrom=5&amp;wx_lazy=1" alt="图片" style="zoom: 80%;" /> 
...
队列是一种**先进先出（FIFO）**的数据结构。顾名思义，队列的数据存储是如同排队一般，先存入的数据先被压出。常与栈一同配合，可发挥最大的实力。  <img src="https://mmbiz.qpic.cn/mmbiz_gif/TdGLaSU675gwBawZm4AtKbyUUqEHRqCKNibekBDiasFHnZZ76Cp8FqOk4fw9pV8NCBia1fe8PkBka7RIoyA20RibqA/640?wx_fmt=gif&amp;tp=webp&amp;wxfrom=5&amp;wx_lazy=1" alt="图片" style="zoom: 80%;" /> 
...
![图片](https://mmbiz.qpic.cn/mmbiz_jpg/TdGLaSU675gwBawZm4AtKbyUUqEHRqCKNavoC9v9mnicvMRnTHJ1Zu3MkORhxuChe9gQOicYGSfHNLZQ53RKuKYA/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1) 
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/NdsdouZwicaebYKoK7rFYNSC0ATdTXVPdhpdptvkIu6OL61fod1wWRb04nyAUVSh8gVErokMxiaLprzibL2uD2W1A/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1) 



#### 1. 二叉树的性质

![图片](https://mmbiz.qpic.cn/mmbiz_png/NdsdouZwicaebYKoK7rFYNSC0ATdTXVPdibucrxRVPpXdOw4mcNIjCj48xULniauF6Y7x6SsZEFIpF3WYTV4IrEjQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1) 
...
![图片](https://mmbiz.qpic.cn/mmbiz_jpg/TdGLaSU675gwBawZm4AtKbyUUqEHRqCKfZB3ze2WZYvbyLVhVqpZzJ6JaS10OcLdW24ichbHhSzL8M1oQSV70zw/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1) 
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/NdsdouZwicaebYKoK7rFYNSC0ATdTXVPdGsR9ic0rPS7eqJ7Miay21NwzxYHVPeJjBB6GcOITcXEf2EKsJ6BMN67A/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1) 

**链表方式：**

![图片](https://mmbiz.qpic.cn/mmbiz_png/NdsdouZwicaebYKoK7rFYNSC0ATdTXVPdZXyDKu8JpL2e2CeKFPWKp9h67cWB6qTj06EHic1cgDRGp6RT0ic4FiaFg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1) 
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/NdsdouZwicaebYKoK7rFYNSC0ATdTXVPdnGbjfHStfsXdYOaSp3vKqADecBFA00Cek9jibs4RHI41axVR6120f8A/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1) 
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/NdsdouZwicaebYKoK7rFYNSC0ATdTXVPdzShHWibxTMKaiaSxE2R4fkAibnw0JEwHY9DiaZXJqakicSlfuVoBmuLFyQg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1) 
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/NdsdouZwicaebYKoK7rFYNSC0ATdTXVPdGNVPhVqHwNiahhiaUqM1jK3OPyufR0D4IpZGZ3y7wotzNu5jlQJZIticQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1) 
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/NdsdouZwicaebYKoK7rFYNSC0ATdTXVPdn4eEqPicGBqLzQTmmR2YP4xHjSKzSN1AdZQL7qq4ia6WNTM7TwkyDYuA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1) 
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/NdsdouZwicaebYKoK7rFYNSC0ATdTXVPdUHTl8BGGqp3Lf2LJUWRuDg0iaAmPRK6yaOVucvbJyeheib5tj2T47ibYQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1) 

其高度与树中结点个数n成对数关系，检索的时间开销为 **$O(logn)$**。但是很有可能检索的时间将变成**线性**的情况。 

 <img src="https://mmbiz.qpic.cn/mmbiz_png/NdsdouZwicaebYKoK7rFYNSC0ATdTXVPdBqP9sxHTTyv62VrO77bvtuRhyFnQOCSR84jzfcI5ia1QFeZsmgU20nA/640?wx_fmt=png&amp;tp=webp&amp;wxfrom=5&amp;wx_lazy=1&amp;wx_co=1" alt="图片" style="zoom:50%;" /> 
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/Lia5wemIHThwrZ76BJubOdqp6CKDmCickzD4PIr5zK4Vt6m1o6OIllmE6FkMosBnKtCTkO3cDQJBtfmBZN2EEJIA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1) 

很多算法和数据结构可以**以空间换时间**，在有序链表上面加一层索引，让部分节点在上层能够直接定位到，这样链表的查询时间近乎减少一半 。

![图片](https://mmbiz.qpic.cn/mmbiz_png/Lia5wemIHThwrZ76BJubOdqp6CKDmCickziciccmUiaqlNuOibxIIU6RZroGa535RMGGYys9bSngRc03mLfaFqOlepnw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1) 
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/Lia5wemIHThwrZ76BJubOdqp6CKDmCickz5vtMTEMLmQZGiaRq5v0QCunWRatzPZS3U8NicSoCnkFQ1CYe5qrqQrFw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1) 
...
最终将按照这个步骤返回正确的节点或者null（说明没查到）。 ![图片](https://mmbiz.qpic.cn/mmbiz_png/Lia5wemIHThwrZ76BJubOdqp6CKDmCickz1txHcqhnT4IiaicW49MHibQNyibW4LvDibTPDxdPaP9ZGeubMAE76vCvQXQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1) 
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/Lia5wemIHThwrZ76BJubOdqp6CKDmCickziaqVGO85FrI2yMHDLFh4vbQAAUbUGzdtCl03mTd5RQefA7VReGkG2Aw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1) 
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/Lia5wemIHThwrZ76BJubOdqp6CKDmCickzRzzvqySUsTIWPtZqjdpLOaX9ScHJCEwLar8K7aEhEpRp7RKm3iaUqPA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1) 
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/Lia5wemIHThwrZ76BJubOdqp6CKDmCickz3Y5vImBzmwTEH2Lsp6UXsLS3gYeeIMT9lnM6wn0wK6eXYXQBbSBvRw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1) 
