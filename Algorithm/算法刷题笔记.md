...
<img src="D:\CodeLearning\ComputerScience\MyNote-git\Algorithm\imgs\1642941419500.png" alt="1642941419500" style="zoom:50%;" />
...
<img src="D:\CodeLearning\ComputerScience\MyNote-git\Algorithm\imgs\1642950639115.png" alt="1642950639115" style="zoom:50%;" />
...
其实就是双指针法，维护两个指针，一个指向当前迭代到的节点，一个指向其前驱节点，这样在反转链表时就不会丢失链表当前迭代节点的前驱节点，动画演示如下：
 ...
 ![img](D:\CodeLearning\ComputerScience\MyNote-git\Algorithm\imgs\008eGmZEly1gnrf1oboupg30gy0c44qp.gif) 
...
class Solution {
    ...
    private ListNode reverse(ListNode pre, ListNode cur) {
        ...
        ListNode temp = cur.next;//先保存下一个节点，防止节点丢失
        cur.next = pre;//反转
        //更新pre、cur指针
        pre = cur;
        cur = temp;
...
![1642993708949](D:\CodeLearning\ComputerScience\MyNote-git\Algorithm\imgs\1642993708949.png)
